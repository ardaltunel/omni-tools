(function initGithubMdProviders(root) {
    ...
    function createProxyPayload(context) {
        ...
        return {
            ...
            repository: {
                ...
                packageSummary: repo.packageSummary,
                dependencies: repo.dependencies,
                projectStructure: repo.projectStructure,
                filePaths: Array.isArray(repo.files) ? repo.files.slice(0, 160) : [],
                sourceExcerpts: Array.isArray(repo.sourceExcerpts) ? repo.sourceExcerpts.slice(0, 8) : [],
    ...
    function createPrompt(context) {
        ...
        const verifiedFacts = {
            ...
            packageSummary: repo.packageSummary || null,
            dependencies: repo.dependencies || null,
        ...
        return [
            ...
            "When additional information is empty, infer the project's purpose and user-facing capabilities from the README, manifest, file paths, and source excerpts. Treat code paths, UI labels, routes, exported functions, and configuration as evidence; make only claims directly supported by that evidence.",
